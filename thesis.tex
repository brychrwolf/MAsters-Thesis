...
\section{CUDA C Runtime}%3.2. CUDA C Runtime}
...
\subsection{Explicit Synchronization}%3.2.5.5.3. Explicit Synchronization}
...
\section{Versioning and Compatibility}%3.3. Versioning and Compatibility}
...
\section{Hardware Implementation}%4. Hardware Implementation}
...
\subsection{SIMT Architecture}%4.1. SIMT Architecture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter[Acceleration by GPGPU]{Acceleration by GPGPU (General-purpose 
