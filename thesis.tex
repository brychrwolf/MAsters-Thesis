...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frontmatter
\todo{update date in final draft}
\maketitle
...
\listoffigures
\listoftables
\listoftodos\todo{Remove listoftodos in final draft}
...
In dense, high-resolution meshes, which can feature several hundred points per mm$^2$~\cite[p.~00]{SourceNeeded}, one can see noise propagating within the results of the MSII filter as jagged outlines.~\cite[s.~3.2]{Mara17}
...
direction. \todo{verify and edit if GigaMesh assumes a counterclockwise direction}
...
\begin{figure}
	...
	\label{fig:geodesicDisc}} %TODO: needs real figure
\end{figure}
...
\subsection{Random Noise Function}%TODO
...
%	\hfill
	...
	GigaMesh~\cite{Mara10} framework with triangle edges rendered.}\label{fig:sq2}}
\end{figure}
