...
\newcommand{\todoFigure}[1]{\todo[color=blue!40]{#1}}
\newcommand{\todoResearch}[1]{\todo[color=teal!40]{#1}}
\newcommand{\todoElaborate}[1]{\todo[color=cyan!40]{#1}}
\newcommand{\todoRemove}[1]{\todo[color=violet!40]{#1}}
...
suscipit, eget imperdiet mauris convallis.~\cite[p.~00]{todoResearch}\todoResearch{citation needed}
...
\subsection{Faces}
Counte-Clokwise vs CloCkwise~\cite[p.~00]{todoResearch}\todoResearch{citation needed}
...
Serial vs Multi-threaded vs GPU order from slow to fast.~\cite[p.~00]{todoResearch}\todoResearch{citation needed}
...
\section{2D filters}
	like from Digital Image Processing: i.e. Jaehne~\cite[p.~00]{todoResearch}\todoResearch{citation needed}
...
\section{Other Mesh filters}
	which I could have done~\cite[p.~00]{todoResearch}\todoResearch{citation needed}



\section{Other approaches to accelerate}
	operations on a mesh~\cite[p.~00]{todoResearch}\todoResearch{citation needed}
...
In dense, high-resolution meshes, which can feature several hundred points per mm$^2$~\cite[p.~00]{todoResearch}\todoResearch{citation needed}, one can see noise propagating within the results of the MSII filter as jagged outlines.~\cite[s.~3.2]{Mara17}
...
\begin{figure}[ht]
	\begin{subfigure}[b]{0.48\linewidth}
		...
		\caption{Sq2 1 Colored, 0 iter}\label{fig:sq2.a}
	\end{subfigure}
	\begin{subfigure}[b]{0.48\linewidth}
		...
		\caption{Sq2 1 Colored, 1 iter}\label{fig:sq2.b}
	\end{subfigure}

	\bigskip
	\begin{subfigure}[b]{0.48\linewidth}
		\includegraphics[width=1.0\linewidth]{data/synthetic_meshes/square_tesselation_2tri_Dirac_delta_100_v40401_f80000_funcvals_0iter_crop.png}
		\caption{Sq2 1000 Colored, 0 iter}\label{fig:sq2.c}
	\end{subfigure}
	\begin{subfigure}[b]{0.48\linewidth}
		\includegraphics[width=1.0\linewidth]{data/synthetic_meshes/square_tesselation_2tri_Dirac_delta_100_v40401_f80000_funcvals_1000iter_crop.png}
		\caption{Sq2 1000 Colored, 1000 iter}\label{fig:sq2.d}
	\end{subfigure}
	...
	GigaMesh~\cite{Mara10} with function values colored with the Improved Hot colorramp, exported as png after disabling the background grid [f7], and screenshot cropping, as well as rejecting tiled rendering, finally cropping to content in GIMP.}\label{fig:sq2}}
\end{figure}\todoResearch{add GIMP citations}
