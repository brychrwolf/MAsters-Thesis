...
Serial is slow. Concurrency is fast.
GPUs are commercially available, so use them.
...
\section{Data Representation}~\cite[p.~25]{Mara12}
...
\subsection{An Ideal Crater}
Ideal Crater like the Mars dataset?
