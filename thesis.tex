...
\newcommand{\Ds}{\Delta^{\kern-3pt\star}}
\newcommand{\Dz}{\Delta\zeta}
%
\newcommand{\xistar}{\left |\xi_\ast \right |}
...
\newcommand{\todoResearch}[1]{\todo[color=cyan!40]{Research: #1}}
\newcommand{\todoBackground}[1]{\todo[color=violet!40]{Bg: #1}}
\newcommand{\todoReword}[1]{\todo[color=magenta!40]{Reword: #1}}
