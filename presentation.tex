...
\frame{\frametitle{Motivation}
	\begin{itemize}
		...
		\item Raw \tdd{} is not suitable for analysis %mesh cleaning uniseigel
		\begin{itemize}
			\item Jagged borders of connected components
			\item Non-manifold faces, singular points, etc.
		\end{itemize}
		\item Neighborhoods of points are arbitrary size and shape
		\item \tdd{} is big, slow to filter without parallelization %tens of millions of points
		\item \glspl{GPGPU} are increasing in power, reducing in cost
	\end{itemize}
