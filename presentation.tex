...
\frame{\frametitle{Motivation}
	\begin{columns}[T]
		\begin{column}{.55\textwidth}
			\begin{itemize}
				\only<1->{
					\item Increasing demand for high-definition, 3D~surface scans
					\begin{itemize}
					...
					\end{itemize}
				}\only<2>{\item Raw \tdd{} is not suitable for analysis
					\begin{itemize}
			...
			\only<1>{
				...
				\begin{columns}[T]
					...
					\begin{column}{.5\textwidth}
						...
						\vspace*{2mm}
						\includegraphics[width=\linewidth]{figures/afterFilter.png}
					\end{column}
				\end{columns}
			}
		\end{column}
