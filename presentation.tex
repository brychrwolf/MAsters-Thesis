...
%------------------------------------------------
%TODO:get correct descripition from mara
...
define three essential metrics:
\begin{align*}
...
\frame{\frametitle{Compute Times per Experiment for increasing Convolution Counts}
	...
	\begin{columns}[T]
		...
		\end{column}
		\begin{column}{.5\textwidth}
			Compute times per experiment, for increasing numbers of convolutions of \fors{t}, onto acquired and synthetic \tdd{} of varying sizes. Combinations involving the smallest mesh sizes are colored red, the largest mesh sizes in blue, with all others scaled in between. The experiments involving acquired \tdd{} are specially marked with squares for the flat surface mesh, and circles for the university seal.
