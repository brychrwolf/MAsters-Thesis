...
Figure~\ref{fig:computeTimesS} shows how compute times increase with both meshsize and number of iterations. \todoResearch{add formula for timing (or at least ref to it) here.}
\begin{figure}[ht]
	\centering
