...
\end{equation}%
\nomenclature[cb]{$\beta$}{the third angle with $\frac{\alpha}{2}$ and $\frac{\pi}{2}$}%
...
\begin{equation}
	...
	\label{eq:zeta}
\end{equation}%
\nomenclature[ea]{$\zeta$}{constant ratio for interpolation derived from Law of Sines}%
...
\end{equation}%
\nomenclature[fa]{$\check{f}$}{the weighted mean function value at $\bc$ of $\bs_i$}%
