...
\ffigbox
	{\includegraphics[width=1.0\linewidth]{figures/triangularFaces.png}}
	{\caption[SIMD Architecture]{The architecture characterized as SIMD by Flynn's Taxonomy\todoCitation{Flynn, 1966 doi:10.1109/TC.1972.5009071.} of systems, where a single instruction is executed simultaneously, in parallel, on }\label{fig:simdArchitecture}}
\end{figure}
