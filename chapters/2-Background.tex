...
\end{align}
\todoReword{write dignificance, in regards to experiments and evaluation}
...
Also important is the notion of an algorithm's ``degree of parallelism'', which is the maximum number of operations which can be executed in parallel. Which leads to the derivation of Amdahl's, which given a contanst problem size $\hat{n}_{fixed}$
\begin{equation}
