...
\end{equation}%
\nomenclature[bd]{$\bt$}{a face}%
\nomenclature[be]{$\bt_j$}{a specific face in $\bT$}%
...
\end{equation}
\todoAsk{do I need a comma with dobule indicies}%
%\nomenclature[bd]{$\bp$}{a point}%
%
