...
\end{equation}
To illustrate the concept, consider the two points $(1, 2)$ and $(5, 1)$, then find the interpolant of a point located at $x = 3$\todoReword{don't use point located at, maybe value sampled at instead?}
\begin{align}
