...
\end{equation}%
\nomenclature[ag]{$\ell_{\sv{i}}$}{the length of distance from point $\bp_v$ to $\bp_i$}%
...
\nomenclature[aj]{$\bp_i$}{a one-ring neighbor of $\bP_v$}%
...
\nomenclature[]{$\bN$}{a family of sets of neighborhoods}%
