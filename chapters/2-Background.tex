...
The equation for calculating the L2-norm of a position vector is
\begin{equation}
	\|\bp\|_2 = \sqrt{\bp_x^2 + \bp_y^2\ + \bp_y^2\|_2}
	\label{eq:l2norm}
\end{equation}
L2-norm is also called the ``Euclidean norm.'' ~\cite{Weisstein19h}
