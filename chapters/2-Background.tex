...
%
%
\subsection{Evaluation and Analysis of Parallel Algorithms}~\cite[p.~330]{Lang17}
Of all the metrics which may be used to evaluate the performance of a parallel algorithm, the most basic include: speedup, efficiency, cost, and the degree of parallelsim, from which  
