...
\end{equation}%
\nomenclature[]{$\bN$}{a set of points comprising a 1-ring neighborhood}%
\nomenclature[]{$\bN_v$}{the set of points comprising the 1-ring neighborhood about $\bP_v$}%
\nomenclature[]{$\widetilde{\bp_v}$}{a 1-ring neighbor of $\bP_v$}%
