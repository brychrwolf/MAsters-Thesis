...
\newglossaryentry{kernel}{
	name=kernel,
	description={in regards to parallel processing in parallel, a set of instructions to be executed simultaneously on multiple processors using multiple elements from a pool of data. Not to be confused with the similar kernel of a one-dimensional Fourier transforms as studied in digital image processing~\cite[p.~44]{Jaehne97}}
}
