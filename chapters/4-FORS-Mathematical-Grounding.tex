...
All that remains for \Fors{t}, is to convolve the filter over the entire set of points comprising the mesh $\bP$, then to collect the computed one-ring \wmfv{s} in the ordered set
%
\begin{equation}
...
\end{equation}%
\nomenclature[]{$\bF'$}{}%
\todoReword{all mentions of set, change to ordered set}
%
