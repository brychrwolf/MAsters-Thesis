...
\begin{tikzpicture}[node distance=0cm]
	...
	\coordinate (center3) at (0cm,-2.25cm);
		...
		\node (fprimev)	[depOp, left of=center3, xshift=5.0cm] {$f'_v$};
	...
	\draw[->, depLine] (vm) .. controls (4cm,-1.5cm) .. (ftildev);
	\draw[->, depLine] (vm) .. controls (6cm,-1.5cm) .. (Atildev);
	...
	\draw[->, depLine, double] (ftildev) -- (fprimev);
	\draw[->, depLine, double] (Atildev) -- (fprimev);

	\draw[->, depLine, double] (fprimev) -- (vm);
