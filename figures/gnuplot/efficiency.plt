...
plot for [i=3:12] data every ::49::56  using 2:i with linespoints title "M.".columnhead(i) ls ceil(5-i*4/10) pt (i==8 ? 5 : (i==10 ? 7 : 1)), \
	 for [i=3:12] data every ::57::64 using 2:i with linespoints title "T.".columnhead(i) ls ceil(4+i*4/10) pt (i==8 ? 5 : (i==10 ? 7 : 1))
