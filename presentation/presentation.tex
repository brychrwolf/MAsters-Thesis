...
\frame{\frametitle{Serial Algorithm for Convolving the Filter}
			...
			\only<1>{
				...
				\begin{block}{Part (2 of 4)}
					...
					\nl					$\kern-0.5pt\alpha \leftarrow cos^{-1}$
										\begin{Large}
											$\kern-6pt\left (\frac{\bE_c^2\,+\,\bE_b^2\,-\,\bE_a^2}{2\,\cdot\,\bE_c\,\cdot\,\bE_b}\right )$\;
										\end{Large}
										\linespread{1.2}\selectfont
					\nl					$\kern0.00pt\beta \leftarrow (\pi - \alpha)\mathbin{/}2$\;
					\nl					$\kern-1.5ptA \leftarrow \Big(\gelm\,\Big)^2\kern-4pt\cdot\alpha\mathbin{/}2$\;
	...
	\begin{tikzpicture}[overlay, remember picture]
		\draw<1>[unirot,ultra thick,rounded corners] (-8mm, 64mm) rectangle (48mm, 50mm);
		\draw<2>[unirot,ultra thick,rounded corners] (-8mm, 50mm) rectangle (48mm, 34mm);
		\draw<3>[unirot,ultra thick,rounded corners] (-8mm, 35mm) rectangle (48mm, 19mm);
	\end{tikzpicture}
}
...
%------------------------------------------------
\frame{\frametitle{Data Dependencies in Serial Algorithms}
	\begin{columns}[t]
		\begin{column}{.5\textwidth}
